...
/mob/living/carbon/human/handle_speech_problems(list/message_pieces, var/verb)
	...
	for(var/datum/multilingual_say_piece/S in message_pieces)
		...
		if(soaped)
			S.message = swearfilter(S.message)
...
// The increasingly off the wall censorship is the point.
/mob/living/carbon/human/proc/swearfilter(var/string_in)
	string_in = replacetext(string_in,"fucking","franking")
	string_in = replacetext(string_in,"fuck","fiddlesticks")
	string_in = replacetext(string_in,"feck","fudge")	
	string_in = replacetext(string_in,"shit","shoot")
	string_in = replacetext(string_in,"shat","shot")	
	string_in = replacetext(string_in,"arse","posterior")
	string_in = replacetext(string_in," ass"," posterior")
	string_in = replacetext(string_in,"-ass","-posterior")
	string_in = replacetext(string_in,"bitch","unpleasant person")	
	string_in = replacetext(string_in,"cunt","crayon")
	string_in = replacetext(string_in,"crap","cranberry")
	string_in = replacetext(string_in,"damn","darn")	
	string_in = replacetext(string_in,"hell","heck")
	string_in = replacetext(string_in,"jesus christ","non-denominational deity of your choice")
	string_in = replacetext(string_in,"jesus","non-denominational deity")	
	string_in = replacetext(string_in,"christ","non-denominational deity")
	string_in = replacetext(string_in,"dick","didgeridoo")
	string_in = replacetext(string_in,"prick","proboscis")	
	string_in = replacetext(string_in,"twat","twirl")
	string_in = replacetext(string_in,"anus","behind")
	string_in = replacetext(string_in,"prick","proboscis")	
	string_in = replacetext(string_in,"balls","bells")
	string_in = replacetext(string_in,"bastard","unpleasant person")
	string_in = replacetext(string_in,"bloody","blistering")	
	string_in = replacetext(string_in,"boob","ballast")
	string_in = replacetext(string_in,"bugger","bother")
	string_in = replacetext(string_in,"bum","posterior")	
	string_in = replacetext(string_in,"butt","posterior")
	string_in = replacetext(string_in,"jerk","jump")
	string_in = replacetext(string_in,"piss","pickle")	
	string_in = replacetext(string_in,"poop","plop")
	string_in = replacetext(string_in,"sex","relations")
	string_in = replacetext(string_in,"pussy","coward")	
	string_in = replacetext(string_in,"tit","bird")
	string_in = replacetext(string_in,"turd","trick")
	string_in = replacetext(string_in,"wank","wand")	
	string_in = replacetext(string_in,"hand","heresy")
	string_in = replacetext(string_in,"penis","toodles")
	string_in = replacetext(string_in,"abortions","ablutions")
	string_in = replacetext(string_in,"cock","rooster")
	return string_in